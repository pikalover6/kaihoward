...
export class SkyAudio {
  ...
  update(engineSpeed, throttle, inside) {
    ...
    this.engineGain.gain.setTargetAtTime(0.045 + throttle * 0.03, t, 0.5)
    const w = Math.pow(Math.min(1, engineSpeed / 150), 2) * 0.5 + inside * 0.4
    this.windGain.gain.setTargetAtTime(w, t, 0.25)
    this.windBP.frequency.setTargetAtTime(380 + engineSpeed * 5 - inside * 200, t, 0.3)
  }
