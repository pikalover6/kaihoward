...
app.get("/authorize", async (c) => {
	...
	return renderApprovalDialog(c.req.raw, {
		...
		csrfToken,
		server: {
			description: "Kai Planner — connect Claude to your personal planner at kaihoward.com/personal. Sign in with GitHub.",
			logo: "https://kaihoward.com/favicon.svg",
			name: "Kai Planner MCP",
		},
		setCookie,
		state: { oauthReqInfo },
	});
